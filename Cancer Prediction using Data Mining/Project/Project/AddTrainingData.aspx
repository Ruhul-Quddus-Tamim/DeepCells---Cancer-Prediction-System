    ...
    <table style="border: 1px solid #C0C0C0; background-image: url('Images/bg.jpg'); " 
        ...
        <tr>
            <td colspan="2" 
                ...
                <asp:Label ID="Label3" runat="server" style="font-family: calibri; font-size: xx-large; color: #FFFFFF;" Text="-- Training Data --"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="right" width="50%">
                <asp:Label ID="Label26" runat="server" style="font-family: gadugi; font-size: large" Text="Cancer Name :"></asp:Label>
            </td>
            <td align="left" width="50%">
                <asp:TextBox ID="TextBox8" runat="server" style="font-family: gadugi" Height="25px" Width="50%"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td align="right" width="50%">
        ...
        <tr>
            ...
            <td width="35%" align="left" style="width: 50%">
                <asp:DropDownList ID="DropDownList1" runat="server" style="font-family: gadugi; font-size: large" Width="30%" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
        ...
        <tr>
            ...
            <td width="35%" align="left" style="width: 50%">
                <asp:TextBox ID="TextBox7" runat="server" style="font-family: gadugi" Height="25px"></asp:TextBox>
    ...
    <table style="border: 1px solid #C0C0C0; background-image: url('Images/bg.jpg'); " 
        ...
        <tr>
            <td align="center" colspan="4">
                ...
                <asp:Button ID="btnAnalyse" runat="server" Text="Add Data" CssClass="style10" 
